        ...
        <div className="min-h-screen w-full max-w-none overflow-x-hidden px-4">
            <div className="p-2">
                <div className="space-y-5">
                    {/* Filters */}
                    <div className=" shadow mt-4 px-6 py-4 flex flex-wrap gap-4 items-center w-full">
                        <div className="flex items-center gap-2 text-white ">
                            <Calendar className="w-5 h-5 text-white" />
                            <input
                                type="date"
                                className="border rounded-lg px-2 py-1 text-sm bg-[#374151] hover:border-gray-300"
                    ...
                    {/* Chart 1 */}
                    <div className="bg-[#1F2937] shadow mt-6 p-4 rounded-lg">
                    ...
                    {/* Chart 2 */}
                    <div className="bg-[#1F2937] rounded-lg shadow mt-6 p-4">
